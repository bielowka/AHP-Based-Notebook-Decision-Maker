...
class QuestionPage(tk.Frame):
    def __init__(self, parent, controller,page_id,generator,layer):
        ...
        if self.matrix.title == "criteria":
            label = tk.Label(self, text="Is "+str(self.inx1) +" more important than "+ str(self.inx2), font=controller.title_font)
        else:
            label = tk.Label(self, text="Is " + str(self.inx1) + " better than " + str(self.inx2) + self.matrix.title, font=controller.title_font)
